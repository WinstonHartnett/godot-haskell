...
module Godot.Core.CubeMap
       (Godot.Core.CubeMap._SIDE_TOP, Godot.Core.CubeMap._SIDE_LEFT,
        Godot.Core.CubeMap._SIDE_RIGHT, Godot.Core.CubeMap._FLAG_REPEAT,
        Godot.Core.CubeMap._FLAG_FILTER, Godot.Core.CubeMap._SIDE_BOTTOM,
        Godot.Core.CubeMap._STORAGE_COMPRESS_LOSSY,
        Godot.Core.CubeMap._STORAGE_COMPRESS_LOSSLESS,
        Godot.Core.CubeMap._SIDE_FRONT, Godot.Core.CubeMap._SIDE_BACK,
        Godot.Core.CubeMap._FLAGS_DEFAULT,
        Godot.Core.CubeMap._FLAG_MIPMAPS, Godot.Core.CubeMap._STORAGE_RAW,
        Godot.Core.CubeMap.get_flags, Godot.Core.CubeMap.get_height,
