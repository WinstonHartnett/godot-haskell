...
module Godot.Core.IP
       (Godot.Core.IP._TYPE_IPV4, Godot.Core.IP._RESOLVER_MAX_QUERIES,
        Godot.Core.IP._TYPE_NONE, Godot.Core.IP._RESOLVER_STATUS_ERROR,
        Godot.Core.IP._TYPE_ANY, Godot.Core.IP._RESOLVER_STATUS_WAITING,
        Godot.Core.IP._TYPE_IPV6, Godot.Core.IP._RESOLVER_STATUS_NONE,
        Godot.Core.IP._RESOLVER_INVALID_ID,
        Godot.Core.IP._RESOLVER_STATUS_DONE, Godot.Core.IP.clear_cache,
