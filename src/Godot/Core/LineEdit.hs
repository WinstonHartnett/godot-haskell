...
module Godot.Core.LineEdit
       (Godot.Core.LineEdit._MENU_PASTE, Godot.Core.LineEdit._MENU_UNDO,
        Godot.Core.LineEdit._MENU_CUT, Godot.Core.LineEdit._MENU_MAX,
        Godot.Core.LineEdit._MENU_SELECT_ALL,
        Godot.Core.LineEdit._ALIGN_CENTER, Godot.Core.LineEdit._MENU_COPY,
        Godot.Core.LineEdit._ALIGN_LEFT, Godot.Core.LineEdit._MENU_REDO,
        Godot.Core.LineEdit._ALIGN_FILL, Godot.Core.LineEdit._MENU_CLEAR,
        Godot.Core.LineEdit._ALIGN_RIGHT,
