...
module Godot.Core.Tween
       (Godot.Core.Tween._TRANS_SINE, Godot.Core.Tween._TRANS_BACK,
        Godot.Core.Tween._TRANS_CIRC, Godot.Core.Tween._EASE_IN_OUT,
        Godot.Core.Tween._TRANS_CUBIC, Godot.Core.Tween._TRANS_LINEAR,
        Godot.Core.Tween._TRANS_ELASTIC, Godot.Core.Tween._TRANS_BOUNCE,
        Godot.Core.Tween._TWEEN_PROCESS_PHYSICS, Godot.Core.Tween._EASE_IN,
        Godot.Core.Tween._TRANS_QUINT,
        Godot.Core.Tween._TWEEN_PROCESS_IDLE, Godot.Core.Tween._TRANS_EXPO,
        Godot.Core.Tween._TRANS_QUAD, Godot.Core.Tween._TRANS_QUART,
        Godot.Core.Tween._EASE_OUT, Godot.Core.Tween._EASE_OUT_IN,
