...
module Godot.Core.Mesh
       (Godot.Core.Mesh._ARRAY_FORMAT_COLOR,
        ...
        Godot.Core.Mesh._ARRAY_VERTEX, Godot.Core.Mesh._PRIMITIVE_LINES,
        Godot.Core.Mesh._PRIMITIVE_TRIANGLE_STRIP,
        Godot.Core.Mesh._ARRAY_BONES, Godot.Core.Mesh._ARRAY_TEX_UV,
        ...
        Godot.Core.Mesh._PRIMITIVE_LINE_LOOP, Godot.Core.Mesh._ARRAY_COLOR,
        Godot.Core.Mesh._BLEND_SHAPE_MODE_NORMALIZED,
        Godot.Core.Mesh._ARRAY_INDEX,
        Godot.Core.Mesh._ARRAY_COMPRESS_TEX_UV2,
        Godot.Core.Mesh._ARRAY_NORMAL, Godot.Core.Mesh._ARRAY_WEIGHTS,
        Godot.Core.Mesh._ARRAY_TANGENT,
        Godot.Core.Mesh._ARRAY_FORMAT_TEX_UV2,
        Godot.Core.Mesh._ARRAY_COMPRESS_TEX_UV, Godot.Core.Mesh._ARRAY_MAX,
